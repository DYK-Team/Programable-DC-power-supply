//
// A sketch for the programmable power supply based on Arduino Uno WiFi Rev2.
// This power supply monitors output voltages from two channels (RED and BLACK): (i) [0-20] V, 8A and (ii) [0-4.2] V, 250 mA.
//
// Authors:
//
// Egor Shevchenko, Dr. Nikolay Udanov, Prof. Larissa Panina, MISiS, Moscow, https://en.misis.ru/ 
//
// Dr. Dmitriy Makhnovskiy, DYK+ team, United Kingdom, https://dykplus.wordpress.com/ 
//
